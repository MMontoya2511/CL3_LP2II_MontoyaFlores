...
public class TblProductocl3 implements Serializable {
	...
	public double getPrecioventacle() {
		return this.precioventacle;
	}

	public void setPrecioventacle(double precioventacle) {
		this.precioventacle = precioventacle;
	}
